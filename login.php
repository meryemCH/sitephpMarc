  ...
  <body>
      ...
      <!-- Right Nav Section -->
        ...
        <li><a href="about.php">Accueil</a></li>
          ...
          if(isset($_SESSION['username'])){
            ...
            echo '<li class="active"><a href="login.php">Connexion</a></li>';
      ...
      <div class="row">
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="submit" id="right-label" value="Se connecter" style="background: #0078A0; border: none; color: #fff; font-family: 'Helvetica Neue', sans-serif; font-size: 1em; padding: 10px;">
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        ...
        <footer>
           <p style="text-align:center; font-size:0.8em;">&copy; MSBeauty. Tous les droits sont reservés. </p>
        </footer>
